...
#define ICM20608_DELAY_CALIBRATION 1
...
#define ICM20608_A_BW_235HZ            0x01
#define ICM20608_A_BW_121HZ            0x02
#define ICM20608_A_BW_61HZ             0x03
#define ICM20608_A_BW_31HZ             0x04
#define ICM20608_A_BW_15HZ             0x05
#define ICM20608_A_BW_7HZ              0x06
...
#define ICM20608_BUFSIZE				256

extern int ICM20608_gyro_power(void);
extern int ICM20608_gyro_mode(void);
#ifdef CONFIG_CUSTOM_KERNEL_SENSORHUB

#define ICM20608G_AXES_NUM        3
/*----------------------------------------------------------------------------*/
enum CUST_ACTION {
	ICM20608G_CUST_ACTION_SET_CUST = 1,
	ICM20608G_CUST_ACTION_SET_CALI,
	ICM20608G_CUST_ACTION_RESET_CALI
};
/*----------------------------------------------------------------------------*/
struct ICM20608G_CUST {
	uint16_t action;
};
/*----------------------------------------------------------------------------*/
struct ICM20608G_SET_CUST {
	uint16_t action;
	uint16_t part;
	int32_t data[0];
};
/*----------------------------------------------------------------------------*/
struct ICM20608G_SET_CALI {
	uint16_t action;
	int32_t data[ICM20608G_AXES_NUM];
};
/*----------------------------------------------------------------------------*/
union ICM20608G_CUST_DATA {
	uint32_t data[10];
	struct ICM20608G_CUST cust;
	struct ICM20608G_SET_CUST setCust;
	struct ICM20608G_SET_CALI setCali;
	struct ICM20608G_CUST resetCali;
};
/*----------------------------------------------------------------------------*/
