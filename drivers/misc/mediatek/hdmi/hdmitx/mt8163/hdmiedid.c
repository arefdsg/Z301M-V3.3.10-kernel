...
{
	print_hex_dump(KERN_CRIT , "HDMI EDID: ", DUMP_PREFIX_NONE, 16, 1, _bEdidData, EDID_SIZE, true);
/*
...
extern bool asus_dongle_support_1080p(void);
...
#define ASUS_1080P_MASK (SINK_1080I60|SINK_1080P60|SINK_1080P30|SINK_1080I50|SINK_1080P50|SINK_1080P25|SINK_1080P24|SINK_1080P23976|SINK_1080P2997)
...
unsigned char fgParserEDID(unsigned char *prbData)
{
	...
	//asus check dongle support 1080p
	if(!asus_dongle_support_1080p()){
		_HdmiSinkAvCap.ui4_sink_cea_ntsc_resolution &= ~ASUS_1080P_MASK;
		_HdmiSinkAvCap.ui4_sink_cea_pal_resolution &= ~ASUS_1080P_MASK;
		_HdmiSinkAvCap.ui4_sink_dtd_ntsc_resolution &= ~ASUS_1080P_MASK;
		_HdmiSinkAvCap.ui4_sink_dtd_pal_resolution &= ~ASUS_1080P_MASK;
		_HdmiSinkAvCap.ui4_sink_1st_dtd_ntsc_resolution &= ~ASUS_1080P_MASK;
		_HdmiSinkAvCap.ui4_sink_1st_dtd_pal_resolution &= ~ASUS_1080P_MASK;
		_HdmiSinkAvCap.ui4_sink_native_ntsc_resolution &= ~ASUS_1080P_MASK;
		_HdmiSinkAvCap.ui4_sink_native_pal_resolution &= ~ASUS_1080P_MASK;
	}
	return TRUE;
}
