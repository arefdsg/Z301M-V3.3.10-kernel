...
extern int Read_BOE_ID(void);

static struct LCM_setting_table lcm_initialization_setting_old[] = {
...
static struct LCM_setting_table lcm_initialization_setting_new[] = {
	{0xFF, 4, {0xAA,0x55,0x25,0x01}},
	{0xFC, 1, {0x08}},
	{REGFLAG_DELAY, 1, {}},
	{0xFC, 1, {0x00}},
	...
	{0xF0, 5, {0x55,0xAA,0x52,0x08,0x02}},
	{0xEE, 1, {0x01}},
	{0xB0, 16, {0x00,0x00,0x00,0x17,0x00,0x3B,0x00,0x57,0x00,0x6F,0x00,0x95,0x00,0xB5,0x00,0xE6}},
	{0xB1, 16, {0x01,0x0E,0x01,0x4D,0x01,0x7E,0x01,0xCA,0x02,0x06,0x02,0x08,0x02,0x40,0x02,0x7A}},
	{0xB2, 16, {0x02,0x9D,0x02,0xD2,0x02,0xF3,0x03,0x21,0x03,0x3E,0x03,0x64,0x03,0x80,0x03,0xA2}},
...
#if defined(CONFIG_Z301M) || defined(CONFIG_Z301MF)
	if(Read_BOE_ID()) {
		pr_debug("[LCM] panel detect: use new BOE panel\n");
		push_table(lcm_initialization_setting_new, sizeof(lcm_initialization_setting_new) / sizeof(struct LCM_setting_table), 1);
	} else {
		pr_debug("[LCM] panel detect: use old BOE panel\n");
		push_table(lcm_initialization_setting_old, sizeof(lcm_initialization_setting_old) / sizeof(struct LCM_setting_table), 1);
	}
#else
