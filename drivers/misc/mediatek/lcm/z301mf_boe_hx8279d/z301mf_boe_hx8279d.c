...
int lcm4_vgp_supply_enable(void)
{
	int ret;
	unsigned int volt;
...
int lcm4_vgp_supply_disable(void)
{
	int ret = 0;
...
LCM_DRIVER z301mf_boe_hx8279d_lcm_drv = {
	.name = "z301mf_boe_hx8279d",
...
static int __init lcm_init(void)
{
	...
	if (!strcmp(z301mf_boe_hx8279d_lcm_drv.name, lk_lcmname)) {
