/*
 * FP5510AAF voice coil motor driver
 *
 *
 */
...
static char SRC[2] = { (char)(0xF2), (char)(0xA0) }; //SRC=10100
...
static int FP5510A_Mode_Init(void)
{
	int i4RetValue = 0;
	//Direct mode
	char Init[2] = { (char)(0xA1), (char)(0x16) };
	char FirstStepCurrent[2] = { (char)(0x10), (char)(0x00) };
	...
	g_position = 0x100; //Default position
	i4RetValue = i2c_master_send(g_pstAF_I2Cclient, FirstStepCurrent, 2);
