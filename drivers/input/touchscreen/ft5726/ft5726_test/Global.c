...
unsigned char get_ic_code(char * strIcName)
{
	...
	if(strncmp(strIcName, "FT5826S",6) == 0) return IC_FT5726; // Add by Tom for IC_Type=FT5826S return FT5726
...
void get_ic_name(unsigned char ucIcCode, char * strIcName)
{
	...
	if(ucIcCode == IC_FT5826S)sprintf(strIcName, "%s",  "FT5726"); // Add by Tom for IC_Type=FT5826S return FT5726
